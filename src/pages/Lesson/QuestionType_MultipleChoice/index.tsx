...
//           <AnswerOption key={index} answerOption={answerOption} selectedAnswer={selectedAnswer} handleAnswer={handleAnswer} showNext={showNext} publicUrl={publicUrl} currentQuestion={currentQuestion} />
//         ))}
//       </div>
//       {explanationText ? (
//         <div style={{ backgroundColor: isCorrectAnswer ? "lightgreen" : "lightcoral" }}>
//           <p className='explanation'>{explanationText}</p>
//           <img src={`${publicUrl}/images/${explanationImg}`} alt='Explanation Image' style={{ width: "10vw" }} />
//         </div>
//       ) : null}
//       <NextSubmitButton showNext={showNext} handleNext={handleNext} handleSubmit={handleSubmit} isAnswerSelected={isAnswerSelected} />
//     </div>
//   );
// };
